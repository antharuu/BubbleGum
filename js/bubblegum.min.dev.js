...
(function () {
  var e = [, function (e, t, n) {
    ...
    }, r.resolve = i, e.exports = r, r.id = 1;
  }, function (e, t, n) {
    var a,
        r,
        i,
      ...
      var t = /\blang(?:uage)?-([\w-]+)\b/i,
        ...
        highlightElement: function highlightElement(n, r, i) {
          ...
          function c(e) {
            d.highlightedCode = e, a.hooks.run("before-insert", d), d.element.innerHTML = d.highlightedCode, a.hooks.run("after-highlight", d), a.hooks.run("complete", d), i && i.call(d.element);
          }

          if (a.hooks.run("before-sanity-check", d), !d.code) return a.hooks.run("complete", d), void (i && i.call(d.element));
        ...
        tokenize: function tokenize(e, t) {
          ...
          var c = new o();
          return s(c, c.head, e), function e(t, n, o, d, c, p) {
            for (var u in o) {
              if (o.hasOwnProperty(u) && o[u]) {
                ...
                for (var m = 0; m < g.length; ++m) {
                  ...
                  if (h && !b.pattern.global) {
                    var T = b.pattern.toString().match(/[imsuy]*$/)[0];
                    b.pattern = RegExp(b.pattern.source, T + "g");
                  }

                  for (var A = b.pattern || b, _ = d.next, y = c; _ !== n.tail && !(p && y >= p.reach); y += _.value.length, _ = _.next) {
                    var R = _.value;
                    ...
                    if (!(R instanceof r)) {
                      ...
                      if (h) {
                        if (!(I = i(A, y, t, f))) break;
                        var k = I.index,
                            w = I.index + I[0].length,
                            C = y;

                        for (C += _.value.length; C <= k;) {
                          C += (_ = _.next).value.length;
                        }

                        if (y = C -= _.value.length, _.value instanceof r) continue;

                        for (var v = _; v !== n.tail && (C < w || "string" == typeof v.value); v = v.next) {
                          N++, C += v.value.length;
                        }

                        N--, R = t.slice(y, C), I.index -= y;
                      } else if (!(I = i(A, 0, R, f))) continue;

                      k = I.index;
                      var O = I[0],
                          L = R.slice(0, k),
                          D = R.slice(k + O.length),
                          x = y + R.length;
                      p && x > p.reach && (p.reach = x);
                      var P = _.prev;
                      L && (P = s(n, P, L), y += L.length), l(n, P, N), _ = s(n, P, new r(u, E ? a.tokenize(O, E) : O, S, O)), D && s(n, _, D), 1 < N && e(t, n, o, _.prev, y, {
                        cause: u + "," + m,
                        reach: x
                      });
                    }
      ...
      if (d && (a.filename = d.src, d.hasAttribute("data-manual") && (a.manual = !0)), !a.manual) {
        ...
        "loading" === p || "interactive" === p && d && d.defer ? document.addEventListener("DOMContentLoaded", c) : window.requestAnimationFrame ? window.requestAnimationFrame(c) : window.setTimeout(c, 16);
      }

      return a;
    }("undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {});

    e.exports && (e.exports = d), void 0 !== n.g && (n.g.Prism = d), d.languages.markup = {
      comment: /<!--[\s\S]*?-->/,
      prolog: /<\?[\s\S]+?\?>/,
      doctype: {
        pattern: /<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,
    ...
    }), d.languages.html = d.languages.markup, d.languages.mathml = d.languages.markup, d.languages.svg = d.languages.markup, d.languages.xml = d.languages.extend("markup", {}), d.languages.ssml = d.languages.xml, d.languages.atom = d.languages.xml, d.languages.rss = d.languages.xml, function (e) {
      var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
      e.languages.css = {
        comment: /\/\*[\s\S]*?\*\//,
        atrule: {
    ...
    }), d.languages.markup && d.languages.markup.tag.addInlined("script", "javascript"), d.languages.js = d.languages.javascript, d.languages.abap = {
      comment: /^\*.*/m,
      string: /(`|')(?:\\.|(?!\1)[^\\\r\n])*\1/m,
      "string-template": {
        pattern: /([|}])(?:\\.|[^\\|{\r\n])*(?=[|{])/,
      ...
      punctuation: /[,.:()]/
    }, a = "(?:ALPHA|BIT|CHAR|CR|CRLF|CTL|DIGIT|DQUOTE|HEXDIG|HTAB|LF|LWSP|OCTET|SP|VCHAR|WSP)", d.languages.abnf = {
      comment: /;.*/,
      string: {
        pattern: /(?:%[is])?"[^"\n\r]*"/,
        greedy: !0,
      ...
      operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/
    }), d.languages.actionscript["class-name"].alias = "function", d.languages.markup && d.languages.insertBefore("actionscript", "string", {
      xml: {
      ...
      operator: /\.\.|->|[|~]|[*+?]\??/,
      punctuation: /[;:()=]/
    }, d.languages.g4 = d.languages.antlr4, d.languages.apacheconf = {
      comment: /#.*/,
      "directive-inline": {
      ...
      e.languages.apex = {
        ...
        "class-name": [{
          pattern: a("(\\b(?:class|enum|extends|implements|instanceof|interface|new|trigger\\s+\\w+\\s+on)\\s+)<CLASS-NAME>"),
          lookbehind: !0,
          inside: r
        }, {
          pattern: a("(\\(\\s*)<CLASS-NAME>(?=\\s*\\)\\s*[\\w(])"),
          lookbehind: !0,
          inside: r
        }, {
          pattern: a("<CLASS-NAME>(?=\\s*\\w+\\s*[;=,(){:])"),
          inside: r
        }],
        trigger: {
    ...
    }), delete d.languages.c["boolean"], i = /\b(?:alignas|alignof|asm|auto|bool|break|case|catch|char|char8_t|char16_t|char32_t|class|compl|concept|const|consteval|constexpr|constinit|const_cast|continue|co_await|co_return|co_yield|decltype|default|delete|do|double|dynamic_cast|else|enum|explicit|export|extern|float|for|friend|goto|if|inline|int|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|long|mutable|namespace|new|noexcept|nullptr|operator|private|protected|public|register|reinterpret_cast|requires|return|short|signed|sizeof|static|static_assert|static_cast|struct|switch|template|this|thread_local|throw|try|typedef|typeid|typename|union|unsigned|using|virtual|void|volatile|wchar_t|while)\b/, (r = d).languages.cpp = r.languages.extend("c", {
      "class-name": [{
    ...
    }, r.languages.cpp["base-clause"]), d.languages.arduino = d.languages.extend("cpp", {
      ...
      var d = l(i),
          ...
          h = "\\[\\s*(?:,\\s*)*\\]",
          S = t("<<0>>(?:\\s*(?:\\?\\s*)?<<1>>)*(?:\\s*\\?)?", [f, h]),
          T = t("(?:<<0>>|<<1>>)(?:\\s*(?:\\?\\s*)?<<2>>)*(?:\\s*\\?)?", [t("\\(<<0>>+(?:,<<0>>+)+\\)", [t("[^,()<>[\\];=+\\-*/%&|^]|<<0>>|<<1>>|<<2>>", [g, m, h])]), f, h]),
          A = {
        keyword: c,
        punctuation: /[<>()?,.:[\]]/
      },
      ...
      e.languages.csharp = e.languages.extend("clike", {
        ...
        "class-name": [{
          pattern: n("(\\busing\\s+static\\s+)<<0>>(?=\\s*;)", [f]),
          lookbehind: !0,
          inside: A
        }, {
          pattern: n("(\\busing\\s+<<0>>\\s*=\\s*)<<1>>(?=\\s*;)", [b, T]),
          lookbehind: !0,
          inside: A
        }, {
          pattern: n("(\\busing\\s+)<<0>>(?=\\s*=)", [b]),
          lookbehind: !0
        }, {
          pattern: n("(\\b<<0>>\\s+)<<1>>", [d, E]),
          lookbehind: !0,
          inside: A
        }, {
          pattern: n("(\\bcatch\\s*\\(\\s*)<<0>>", [f]),
          lookbehind: !0,
          inside: A
        }, {
          pattern: n("(\\bwhere\\s+)<<0>>", [b]),
          lookbehind: !0
        }, {
          pattern: n("(\\b(?:is(?:\\s+not)?|as)\\s+)<<0>>", [S]),
          lookbehind: !0,
          inside: A
        }, {
          pattern: n("\\b<<0>>(?=\\s+(?!<<1>>)<<2>>(?:\\s*[=,;:{)\\]]|\\s+(?:in|when)\\b))", [T, u, b]),
          inside: A
        }],
        keyword: c,
        ...
        namespace: {
          pattern: n("(\\b(?:namespace|using)\\s+)<<0>>(?:\\s*\\.\\s*<<0>>)*(?=\\s*[;{])", [b]),
          lookbehind: !0,
          inside: {
            punctuation: /\./
          }
        ...
        "return-type": {
          pattern: n("<<0>>(?=\\s+(?:<<1>>\\s*(?:=>|[({]|\\.\\s*this\\s*\\[)|this\\s*\\[))", [T, f]),
          inside: A,
          alias: "class-name"
        },
        "constructor-invocation": {
          pattern: n("(\\bnew\\s+)<<0>>(?=\\s*[[({])", [T]),
          lookbehind: !0,
          inside: A,
          alias: "class-name"
        },
        "generic-method": {
          pattern: n("<<0>>\\s*<<1>>(?=\\s*\\()", [b, g]),
          inside: {
            "function": n("^<<0>>", [b]),
            generic: {
              pattern: RegExp(g),
        ...
        "type-list": {
          pattern: n("\\b((?:<<0>>\\s+<<1>>|where\\s+<<2>>)\\s*:\\s*)(?:<<3>>|<<4>>)(?:\\s*,\\s*(?:<<3>>|<<4>>))*(?=\\s*(?:where|[{;]|=>|$))", [d, E, b, T, c.source]),
          lookbehind: !0,
          inside: {
            keyword: c,
            "class-name": {
      ...
      e.languages.insertBefore("csharp", "class-name", {
        attribute: {
          pattern: n("((?:^|[^\\s\\w>)?])\\s*\\[\\s*)(?:<<0>>\\s*:\\s*)?<<1>>(?:\\s*,\\s*<<1>>)*(?=\\s*\\])", [k, w]),
          lookbehind: !0,
          greedy: !0,
          inside: {
            target: {
    ...
    }(d), d.languages.dotnet = d.languages.cs = d.languages.csharp, d.languages.aspnet = d.languages.extend("markup", {
      "page-directive": {
        pattern: /<%\s*@.*%>/i,
        alias: "tag",
        inside: {
          ...
          rest: d.languages.markup.tag.inside
        }
      },
      directive: {
        pattern: /<%.*%>/i,
        ...
        inside: {
          ...
          rest: d.languages.csharp
        }
      }
    }), d.languages.aspnet.tag.pattern = /<(?!%)\/?[^\s>\/]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|[^\s'">=]+))?)*\s*\/?>/i, d.languages.insertBefore("inside", "punctuation", {
      directive: d.languages.aspnet.directive
    }, d.languages.aspnet.tag.inside["attr-value"]), d.languages.insertBefore("aspnet", "comment", {
      "asp-comment": {
        pattern: /<%--[\s\S]*?--%>/,
        alias: ["asp", "comment"]
      }
    }), d.languages.insertBefore("aspnet", d.languages.javascript ? "script" : "tag", {
      "asp-script": {
        pattern: /(<script(?=.*runat=['"]?server['"]?)[^>]*>)[\s\S]*?(?=<\/script>)/i,
        lookbehind: !0,
        alias: ["asp", "script"],
        inside: d.languages.csharp || {}
      }
    }), d.languages.asm6502 = {
      comment: /;.*/,
      directive: {
    ...
    }, d.languages.shortcode = d.languages.bbcode, d.languages.birb = d.languages.extend("clike", {
      string: {
        pattern: /r?("|')(?:\\.|(?!\1)[^\\])*\1/,
        greedy: !0
      },
      ...
      operator: /\+\+|--|&&|\|\||<<=?|>>=?|~(?:\/=?)?|[+\-*\/%&^|=!<>]=?|\?|:/,
      variable: /\b[a-z_]\w*\b/
    }), d.languages.insertBefore("birb", "function", {
      metadata: {
        pattern: /<\w+>/,
        greedy: !0,
        alias: "symbol"
      }
    }), d.languages.bison = d.languages.extend("c", {}), d.languages.insertBefore("bison", "comment", {
      bison: {
        pattern: /^(?:[^%]|%(?!%))*%%[\s\S]*?%%/,
        inside: {
          c: {
      ...
      operator: /::=|[|()[\]{}*+?]|\.{3}/
    }, d.languages.rbnf = d.languages.bnf, d.languages.brainfuck = {
      pointer: {
        pattern: /<|>/,
        alias: "keyword"
      },
    ...
    }, d.languages.brightscript["directive-statement"].inside.expression.inside = d.languages.brightscript, d.languages.bro = {
      comment: {
        pattern: /(^|[^\\$])#.*/,
        lookbehind: !0,
        inside: {
    ...
    }, d.languages.oscript = d.languages.bsl, d.languages.cil = {
      comment: /\/\/.*/,
      string: {
        pattern: /(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,
        greedy: !0
    ...
    }, d.languages.insertBefore("concurnas", "langext", {
      string: {
        pattern: /[rs]?("|')(?:\\.|(?!\1)[^\\\r\n])*\1/,
        greedy: !0,
        inside: {
          interpolation: {
            pattern: /((?:^|[^\\])(?:\\{2})*){(?:[^{}]|{(?:[^{}]|{[^}]*})*})+}/,
            lookbehind: !0,
            inside: d.languages.concurnas
          },
          string: /[\s\S]+/
        }
      }
    }), d.languages.conc = d.languages.concurnas, d.languages.csp = {
      directive: {
      ...
      operator: /:|<--?|--?>?|<>|=~?|[<>]=?|[+*/%^|]|\.\.\.?/,
      punctuation: /[()[\]{},;.]/
    }, d.languages.d = d.languages.extend("clike", {
      comment: [{
        pattern: /^\s*#!.+/,
        greedy: !0
      }, {
    ...
    }), d.languages.insertBefore("d", "keyword", {
      property: /\B@\w*/
    }), d.languages.insertBefore("d", "function", {
      register: {
        pattern: /\b(?:[ABCD][LHX]|E[ABCD]X|E?(?:BP|SP|DI|SI)|[ECSDGF]S|CR[0234]|DR[012367]|TR[3-7]|X?MM[0-7]|R[ABCD]X|[BS]PL|R[BS]P|[DS]IL|R[DS]I|R(?:[89]|1[0-5])[BWD]?|XMM(?:[89]|1[0-5])|YMM(?:1[0-5]|\d))\b|\bST(?:\([0-7]\)|\b)/,
        alias: "variable"
      }
    }), d.languages.dart = d.languages.extend("clike", {
      string: [{
        pattern: /r?("""|''')[\s\S]*?\1/,
        greedy: !0
      }, {
    ...
    }), d.languages.insertBefore("dart", "function", {
      metadata: {
        pattern: /@\w+/,
        alias: "symbol"
      }
    }), d.languages.dataweave = {
    ...
    }, d.languages.dhall.string.inside.interpolation.inside.expression.inside = d.languages.dhall, function (e) {
      e.languages.diff = {
        coord: [/^(?:\*{3}|-{3}|\+{3}).*$/m, /^@@.*@@$/m, /^\d.*$/m]
      };
      var t = {
              ...
              !function o(s) {
                for (var l = 0; l < s.length && !(r >= i.length); l++) {
                  ...
                  if ("string" == typeof d || d.content && "string" == typeof d.content) {
                    ...
                    if (-1 < m) {
                      ++r;
                      var b = u.substring(0, m),
                          E = new e.Token(a, e.tokenize(p, n.grammar), "language-" + a, p),
                          f = u.substring(m + g.length),
                          h = [];
                      b && h.push.apply(h, o([b])), h.push(E), f && h.push.apply(h, o([f])), "string" == typeof d ? s.splice.apply(s, [l, 1].concat(h)) : d.content = h;
                    }
      ...
      punctuation: /[()]/
    }, d.languages["dns-zone"] = d.languages["dns-zone-file"], d.languages.docker = {
      keyword: {
      ...
      punctuation: /---|\.\.\.|[:[\]{}\-,|>?]/
    }, d.languages.dockerfile = d.languages.docker, d.languages.ebnf = {
      comment: /\(\*[\s\S]*?\*\)/,
      string: {
        pattern: /"[^"\r\n]*"|'[^'\r\n]*'/,
        greedy: !0
    ...
    }(d), (o = d).languages.erb = o.languages.extend("ruby", {}), o.languages.insertBefore("erb", "comment", {
      delimiter: {
        pattern: /^<%=?|%>$/,
        alias: "punctuation"
      }
    }), o.hooks.add("before-tokenize", function (e) {
      o.languages["markup-templating"].buildPlaceholders(e, "erb", /<%=?(?:[^\r\n]|[\r\n](?!=begin)|[\r\n]=begin\s[\s\S]*?^=end)+?%>/gm);
    }), o.hooks.add("after-tokenize", function (e) {
      o.languages["markup-templating"].tokenizePlaceholders(e, "erb");
    }), d.languages.erlang = {
      comment: /%.+/,
      string: {
        pattern: /"(?:\\.|[^\\"\r\n])*"/,
      ...
      operator: /[-+*/^%=&,]|<[=>]?|>=?/,
      punctuation: /[[\]();{}|]/
    }, d.languages.xlsx = d.languages.xls = d.languages["excel-formula"], d.languages.fsharp = d.languages.extend("clike", {
      comment: [{
        pattern: /(^|[^\\])\(\*[\s\S]*?\*\)/,
        lookbehind: !0
      }, {
    ...
    }), (s = d).languages.flow = s.languages.extend("javascript", {}), s.languages.insertBefore("flow", "keyword", {
      type: [{
      ...
      a.string[1].inside.interpolation.inside.rest = a, e.languages.ftl = {
        "ftl-comment": {
          pattern: /^<#--[\s\S]*/,
          alias: "comment"
        },
        ...
        var a = RegExp("<#--[^]*?--\x3e|</?[#@][a-zA-Z](?:<expr>)*?>|\\$\\{(?:<expr>)*?\\}".replace(/<expr>/g, function () {
          return t;
        }), "gi");
    ...
    }(d), d.languages.gamemakerlanguage = d.languages.gml = d.languages.extend("clike", {
    ...
    }, d.languages.glsl = d.languages.extend("c", {
    ...
    }), delete d.languages.go["class-name"], d.languages.graphql = {
      comment: /#.*/,
      description: {
        pattern: /(?:"""(?:[^"]|(?!""")")*"""|"(?:\\.|[^\\"\r\n])*")(?=\s*[a-z_])/i,
        greedy: !0,
    ...
    }, d.languages.groovy = d.languages.extend("clike", {
      string: [{
        pattern: /("""|''')(?:[^\\]|\\[\s\S])*?\1|\$\/(?:[^/$]|\$(?:[/$]|(?![/$]))|\/(?!\$))*\/\$/,
        greedy: !0
      }, {
      ...
      punctuation: /\.+|[{}[\];(),:$]/
    }), d.languages.insertBefore("groovy", "string", {
      shebang: {
        pattern: /#!.+/,
        alias: "comment"
      }
    }), d.languages.insertBefore("groovy", "punctuation", {
      "spock-block": /\b(?:setup|given|when|then|and|cleanup|expect|where):/
    }), d.languages.insertBefore("groovy", "function", {
      annotation: {
        pattern: /(^|[^.])@\w+/,
        lookbehind: !0,
        alias: "punctuation"
      ...
      if ("groovy" === e.language && "string" === e.type) {
        ...
        if ("'" != t) {
          var n = /([^\\])(?:\$(?:\{.*?\}|[\w.]+))/;
          "$" === t && (n = /([^\$])(?:\$(?:\{.*?\}|[\w.]+))/), e.content = e.content.replace(/&lt;/g, "<").replace(/&amp;/g, "&"), e.content = d.highlight(e.content, {
            expression: {
              pattern: n,
              lookbehind: !0,
              inside: d.languages.groovy
            }
      ...
      constant: /\b(?:[A-Z][\w']*\.)*[A-Z][\w']*\b/,
      punctuation: /[{}[\];(),.:]/
    }, d.languages.hs = d.languages.haskell, d.languages.haxe = d.languages.extend("clike", {
      string: {
        pattern: /(["'])(?:(?!\1)[^\\]|\\[\s\S])*\1/,
        greedy: !0,
        inside: {
      ...
      operator: /\.{3}|\+\+?|-[->]?|[=!]=?|&&?|\|\|?|<[<=]?|>[>=]?|[*\/%~^]/
    }), d.languages.insertBefore("haxe", "class-name", {
      regex: {
        pattern: /~\/(?:[^\/\\\r\n]|\\.)+\/[igmsu]*/,
        greedy: !0
      }
    }), d.languages.insertBefore("haxe", "keyword", {
      preprocessor: {
        pattern: /#\w+/,
        alias: "builtin"
      },
    ...
    }), d.languages.haxe.string.inside.interpolation.inside.rest = d.languages.haxe, delete d.languages.haxe["class-name"], d.languages.hcl = {
      comment: /(?:\/\/|#).*|\/\*[\s\S]*?(?:\*\/|$)/,
      heredoc: {
        pattern: /<<-?(\w+\b)[\s\S]*?^[ \t]*\1/m,
        greedy: !0,
      ...
      "boolean": /\b(?:true|false)\b/i,
      punctuation: /[=\[\]{}]/
    }, d.languages.hlsl = d.languages.extend("c", {
      "class-name": [d.languages.c["class-name"], /\b(?:AppendStructuredBuffer|BlendState|Buffer|ByteAddressBuffer|CompileShader|ComputeShader|ConsumeStructuredBuffer|DepthStencilState|DepthStencilView|DomainShader|GeometryShader|Hullshader|InputPatch|LineStream|OutputPatch|PixelShader|PointStream|RasterizerState|RenderTargetView|RWBuffer|RWByteAddressBuffer|RWStructuredBuffer|RWTexture(?:1D|1DArray|2D|2DArray|3D)|SamplerComparisonState|SamplerState|StructuredBuffer|Texture(?:1D|1DArray|2D|2DArray|2DMS|2DMSArray|3D|Cube|CubeArray)|TriangleStream|VertexShader)\b/],
      ...
      for (var s in i) {
        if (i[s]) {
          ...
          t[s.replace(/\//g, "-")] = {
            pattern: RegExp("(content-type:\\s*" + l + ".*)(?:\\r?\\n|\\r){2}[\\s\\S]*", "i"),
            lookbehind: !0,
            inside: i[s]
          };
        }
      ...
      punctuation: /[.,:;(){}]/
    }, d.languages.inform7.string.inside.substitution.inside.rest = d.languages.inform7, d.languages.inform7.string.inside.substitution.inside.rest.text = {
      pattern: /\S(?:\s*\S)*/,
      alias: "comment"
    }, d.languages.ini = {
      comment: /^[ \t]*[;#].*$/m,
          ...
          "string" == typeof t && (t = [t]), t.forEach(function (t) {
            !function (t, n) {
              ...
              if (r) {
                ...
                if (!i) {
                  i = (r = e.languages.insertBefore(t, "comment", {
                    "doc-comment": {
                      pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/,
                      lookbehind: !0,
                      alias: "comment"
                ...
                if (i instanceof RegExp && (i = r[a] = {
                  pattern: i
                }), Array.isArray(i)) for (var o = 0, s = i.length; o < s; o++) {
    ...
    }, d.languages.jolie = d.languages.extend("clike", {
      string: {
        pattern: /(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,
        greedy: !0
      },
      ...
      symbol: /[|;@]/
    }), delete d.languages.jolie["class-name"], d.languages.insertBefore("jolie", "keyword", {
      "function": {
      ...
      for (var n = ["function", "function-variable", "method", "method-variable", "property-access"], a = 0; a < n.length; a++) {
        ...
        var o = i.inside || {};
        (i.inside = o)["maybe-class-name"] = /^[A-Z][\s\S]*/;
      }
    }(d), d.languages.json = {
      property: {
        pattern: /(^|[^\\])"(?:\\.|[^\\"\r\n])*"(?=\s*:)/,
    ...
    }, d.languages.webmanifest = d.languages.json, function (e) {
      var t = /("|')(?:\\(?:\r\n?|\n|.)|(?!\1)[^\\\r\n])*\1/;
    ...
    }(d), d.languages.jsonp = d.languages.extend("json", {
      punctuation: /[{}[\]();,.]/
    }), d.languages.insertBefore("jsonp", "punctuation", {
      "function": /(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*\()/
    }), d.languages.jsstacktrace = {
      "error-message": {
        pattern: /^\S.*/m,
        alias: "string"
      },
      ...
      function s(t, n, a) {
        ...
        return e.hooks.run("before-tokenize", r), r.tokens = e.tokenize(r.code, r.grammar), e.hooks.run("after-tokenize", r), r.tokens;
      }
      ...
      function l(t) {
        ...
        if (3 === i.length) {
          var o = [1, 1];
          o.push.apply(o, s(i[1], e.languages.javascript, "javascript")), i.splice.apply(i, o);
        }
      ...
      function d(t, n, a) {
        var r = e.tokenize(t, {
          interpolation: {
            ...
            o = 0,
            d = {},
            c = s(r.map(function (e) {
          if ("string" == typeof e) return e;

          for (var n, r = e.content; -1 !== t.indexOf((i = o++, n = "___" + a.toUpperCase() + "_" + i + "___"));) {
            ;
          }
          ...
          for (var n = 0; n < t.length; n++) {
            ...
            if ("string" == typeof a || "string" == typeof a.content) {
              ...
              if (-1 !== s) {
                ...
                if (c && m.push(c), m.push(u), g) {
                  var b = [g];
                  e(b), m.push.apply(m, b);
                }

                "string" == typeof a ? (t.splice.apply(t, [n, 1].concat(m)), n += m.length - 1) : a.content = m;
              }
            } else {
              var E = a.content;
      ...
      e.languages.javascript["template-string"] = [o("css", "\\b(?:styled(?:\\([^)]*\\))?(?:\\s*\\.\\s*\\w+(?:\\([^)]*\\))*)*|css(?:\\s*\\.\\s*(?:global|resolve))?|createGlobalStyle|keyframes)"), o("html", "\\bhtml|\\.\\s*(?:inner|outer)HTML\\s*\\+?="), o("svg", "\\bsvg"), o("markdown", "\\b(?:md|markdown)"), o("graphql", "\\b(?:gql|graphql(?:\\s*\\.\\s*experimental)?)"), t].filter(Boolean);
      var c = {
        javascript: !0,
        js: !0,
        typescript: !0,
      ...
      e.languages.insertBefore("inside", "attr-value", {
        ...
        "latte" === n.language && (e.languages["markup-templating"].buildPlaceholders(n, "latte", /\{\*[\s\S]*?\*\}|\{[^'"\s{}*](?:[^"'/{}]|\/(?![*/])|("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|\/\*(?:[^*]|\*(?!\/))*\*\/)*?\}/g), n.grammar = t);
      }), e.hooks.add("after-tokenize", function (t) {
        e.languages["markup-templating"].tokenizePlaceholders(t, "latte");
      });
    }(d), d.languages.less = d.languages.extend("css", {
      comment: [/\/\*[\s\S]*?\*\//, {
        pattern: /(^|[^\\])\/\/.*/,
        lookbehind: !0
      }],
      ...
      var a = "[-+*/_~!@$%^=<>{}\\w]+",
        ...
        keyword: [{
          pattern: RegExp(r + "(?:(?:lexical-)?let\\*?|(?:cl-)?letf|if|when|while|unless|cons|cl-loop|and|or|not|cond|setq|error|message|null|require|provide|use-package)" + o),
          lookbehind: !0
        }, {
          pattern: RegExp(r + "(?:for|do|collect|return|finally|append|concat|in|by)" + o),
          lookbehind: !0
        }],
        declare: {
          pattern: t("declare"),
        ...
        defvar: {
          pattern: RegExp(r + "def(?:var|const|custom|group)\\s+" + a),
          lookbehind: !0,
          inside: {
            keyword: /^def[a-z]+/,
            variable: RegExp(a)
        ...
        defun: {
          pattern: RegExp(r + "(?:cl-)?(?:defun\\*?|defmacro)\\s+" + a + "\\s+\\([\\s\\S]*?\\)"),
          lookbehind: !0,
          inside: {
            keyword: /^(?:cl-)?def\S+/,
            arguments: null,
        ...
        lambda: {
          pattern: RegExp(r + "lambda\\s+\\(\\s*(?:&?" + a + "(?:\\s+&?" + a + ")*\\s*)?\\)"),
          lookbehind: !0,
          inside: {
            keyword: /^lambda/,
            arguments: null,
      ...
      s.lambda.inside.arguments = c, s.defun.inside.arguments = e.util.clone(c), s.defun.inside.arguments.inside.sublist = c, e.languages.lisp = s, e.languages.elisp = s, e.languages.emacs = s, e.languages["emacs-lisp"] = s;
    }(d), d.languages.livescript = {
      comment: [{
        pattern: /(^|[^\\])\/\*[\s\S]*?\*\//,
        lookbehind: !0
      }, {
      ...
      punctuation: /[(){}\[\]|.,:;`]/
    }, d.languages.livescript["interpolated-string"].inside.interpolation.inside.rest = d.languages.livescript, d.languages.llvm = {
      comment: /;.*/,
      string: {
        pattern: /"[^"]*"/,
        greedy: !0
      ...
      punctuation: /<<|>>|[.,:;?\[\](){}]/
    }, d.languages.mel.code.inside.rest = d.languages.mel, d.languages.mizar = {
      comment: /::.+/,
      ...
      punctuation: /[.,()[\]{}\\]/
    }, d.languages.moonscript.string[1].inside.interpolation.inside.moonscript.inside = d.languages.moonscript, d.languages.moon = d.languages.moonscript, d.languages.n1ql = {
      comment: /\/\*[\s\S]*?(?:$|\*\/)/,
      parameter: /\$[\w.]+/,
      string: {
        pattern: /(["'])(?:\\[\s\S]|(?!\1)[^\\]|\1\1)*\1/,
    ...
    }), d.languages.n4jsd = d.languages.n4js, d.languages["nand2tetris-hdl"] = {
      comment: /\/\/.*|\/\*[\s\S]*?(?:\*\/|$)/,
          ...
          if ("string" != typeof e && "generic-text" === e.type) {
            ...
            (function (e) {
              for (var t = [], n = 0; n < e.length; n++) {
                var a = e[n],
                    r = "[]{}".indexOf(a);
                if (-1 !== r) if (r % 2 == 0) t.push(r + 1);else if (t.pop() !== r) return !1;
              }
      ...
      punctuation: /[,:=[\]{}()-]/
    }, d.languages.nginx = d.languages.extend("clike", {
      comment: {
        pattern: /(^|[^"{\\])#.*/,
        lookbehind: !0
      },
    ...
    }), d.languages.insertBefore("nginx", "keyword", {
      variable: /\$[a-z_]+/i
    }), d.languages.nim = {
      comment: /#.*/,
      string: {
      ...
      operator: /[=!<>]=?|\+\+?|\|\||&&|\/\/|->?|[?@]/,
      punctuation: /[{}()[\].,:;]/
    }, d.languages.nix.string.inside.interpolation.inside.rest = d.languages.nix, d.languages.nsis = {
      comment: {
        pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|[#;].*)/,
        lookbehind: !0
      },
      ...
      operator: /-[->]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|\|?|[~^%?*\/@]/
    }), delete d.languages.objectivec["class-name"], d.languages.objc = d.languages.objectivec, d.languages.ocaml = {
      comment: /\(\*[\s\S]*?\*\)/,
      string: [{
        pattern: /"(?:\\.|[^\\\r\n"])*"/,
        greedy: !0
      ...
      keyword: (l = ["breakpoint", "break", "dbg_down", "dbg_err", "dbg_up", "dbg_x", "forcomposite", "fordiv", "forell", "forpart", "forprime", "forstep", "forsubgroup", "forvec", "for", "iferr", "if", "local", "my", "next", "return", "until", "while"], l = l.map(function (e) {
        return e.split("").join(" *");
      }).join("|"), RegExp("\\b(?:" + l + ")\\b")),
      "function": /\w(?:[\w ]*\w)?(?= *\()/,
      number: {
      ...
      punctuation: /\(\.|\.\)|[()\[\]:;,.]/
    }, d.languages.objectpascal = d.languages.pascal, function (e) {
      var t = "(?:\\w+(?:<braces>)?|<braces>)".replace(/<braces>/g, function () {
        return "\\((?:[^()]|\\((?:[^()]|\\([^()]*\\))*\\))*\\)";
      }),
        ...
        punctuation: /\(\.|\.\)|[()\[\]:;,.{}]/
          ...
          a = ["comment", "keyword", "builtin", "operator", "punctuation"].reduce(function (e, t) {
        return e[t] = n[t], e;
      }, {});
      n["class-name"].forEach(function (e) {
        e.inside = a;
      });
    }(d), d.languages.pcaxis = {
      string: /"[^"]*"/,
      keyword: {
      ...
      "boolean": /YES|NO/
    }, d.languages.px = d.languages.pcaxis, d.languages.peoplecode = {
      ...
      operator: /<>|[<>]=?|!=|\*\*|[-+*/|=@]/,
      punctuation: /[:.;,()[\]]/
    }, d.languages.pcode = d.languages.peoplecode, d.languages.perl = {
      comment: [{
    ...
    }(d), d.languages.insertBefore("php", "variable", {
      "this": /\$this\b/,
      ...
      operator: /[-+*\/&?@^]|<(?:=>?|>)?|>=?|=>?|\.\.\.?/,
      punctuation: /[,;\[\](){}]/
    }, d.languages.pq = d.languages.powerquery, d.languages.mscript = d.languages.powerquery, function (e) {
      var t = d.languages.powershell = {
        comment: [{
          pattern: /(^|[^`])<#[\s\S]*?#>/,
          lookbehind: !0
        }, {
    ...
    }), d.languages.processing["function"] = /\w+(?=\s*\()/, d.languages.processing["class-name"].alias = "variable", d.languages.prolog = {
      comment: [/%.+/, /\/\*[\s\S]*?\*\//],
      string: {
        pattern: /(["'])(?:\1\1|\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,
        greedy: !0
    ...
    }(d), d.languages.purebasic = d.languages.extend("clike", {
      comment: /;.*/,
      ...
      operator: /(?:@\*?|\?|\*)\w+|-[>-]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|?\||[~^%?*/@]/
    }), d.languages.insertBefore("purebasic", "keyword", {
      tag: /#\w+/,
      asm: {
        pattern: /(^\s*)!.*/m,
        lookbehind: !0,
    ...
    }), delete d.languages.purebasic["class-name"], delete d.languages.purebasic["boolean"], d.languages.pbfasm = d.languages.purebasic, d.languages.purescript = d.languages.extend("haskell", {
    ...
    }), d.languages.purs = d.languages.purescript, d.languages.python = {
      comment: {
        pattern: /(^|[^\\])#.*/,
        lookbehind: !0
      },
      ...
      operator: /[-+%=]=?|!=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
      punctuation: /[{}[\];(),.:]/
    }, d.languages.python["string-interpolation"].inside.interpolation.inside.rest = d.languages.python, d.languages.py = d.languages.python, d.languages.q = {
      string: /"(?:\\.|[^"\\\r\n])*"/,
      comment: [{
        pattern: /([\t )\]}])\/.*/,
        lookbehind: !0,
    ...
    }(d), d.languages.qore = d.languages.extend("clike", {
      comment: {
        pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|(?:\/\/|#).*)/,
        lookbehind: !0
      },
      ...
      operator: /->?>?|<(?:=|<?-)?|[>=!]=?|::?|&&?|\|\|?|[+*\/^$@~]/,
      punctuation: /[(){}\[\],;]/
    }, d.languages.racket = d.languages.extend("scheme", {
      "lambda-parameter": {
        pattern: /(\(lambda\s+\()[^()'\s]+/,
        lookbehind: !0
      }
    }), d.languages.DFS(d.languages.racket, function (e, t) {
      if ("RegExp" === d.util.type(t)) {
        var n = t.source.replace(/\\(.)|\[\^?((?:\\.|[^\\\]])*)\]/g, function (e, t, n) {
          if (t) {
            if ("(" === t) return "[([]";
            if (")" === t) return "[)\\]]";
          }

          return n ? ("^" === e[1] ? "[^" : "[") + n.replace(/\\(.)|[()]/g, function (e, t) {
            return "(" === e || "(" === t ? "([" : ")" === e || ")" === t ? ")\\]" : e;
          }) + "]" : e;
        });
        this[e] = RegExp(n, t.flags);
      }
    }), d.languages.insertBefore("racket", "string", {
      lang: {
        pattern: /^#lang.+/m,
        greedy: !0,
        alias: "keyword"
      }
    }), d.languages.rkt = d.languages.racket, function (e) {
      ...
      var n = function n(e) {
        ...
        for (var r = [], i = 0; i < t.length; i++) {
          ...
          if ("string" != typeof o && ("tag" === o.type && o.content[0] && "tag" === o.content[0].type ? "</" === o.content[0].content[0].content ? 0 < r.length && r[r.length - 1].tagName === n(o.content[0].content[1]) && r.pop() : "/>" === o.content[o.content.length - 1].content || r.push({
            tagName: n(o.content[0].content[1]),
            openedBraces: 0
          }) : 0 < r.length && "punctuation" === o.type && "{" === o.content ? r[r.length - 1].openedBraces++ : 0 < r.length && 0 < r[r.length - 1].openedBraces && "punctuation" === o.type && "}" === o.content ? r[r.length - 1].openedBraces-- : s = !0), (s || "string" == typeof o) && 0 < r.length && 0 === r[r.length - 1].openedBraces) {
            var l = n(o);
            i < t.length - 1 && ("string" == typeof t[i + 1] || "plain-text" === t[i + 1].type) && (l += n(t[i + 1]), t.splice(i + 1, 1)), 0 < i && ("string" == typeof t[i - 1] || "plain-text" === t[i - 1].type) && (l = n(t[i - 1]) + l, t.splice(i - 1, 1), i--), t[i] = new e.Token("plain-text", l, null, l);
          }
    ...
    }(d), d.languages.reason = d.languages.extend("clike", {
      string: {
        pattern: /"(?:\\(?:\r\n|[\s\S])|[^\\\r\n"])*"/,
        greedy: !0
      },
      ...
      punctuation: /[{}[\];(),.:]/
    }, d.languages.rpy = d.languages.renpy, d.languages.rest = {
      table: [{
        pattern: /(\s*)(?:\+[=-]+)+\+(?:\r?\n|\r)(?:\1[+|].+[+|](?:\r?\n|\r))+\1(?:\+[=-]+)+\+/,
        lookbehind: !0,
        inside: {
    ...
    }(d), d.languages.scss = d.languages.extend("css", {
      comment: {
        pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,
        lookbehind: !0
      },
    ...
    }), d.languages.scss.atrule.inside.rest = d.languages.scss, d.languages.scala = d.languages.extend("java", {
      "triple-quoted-string": {
        pattern: /"""[\s\S]*?"""/,
        greedy: !0,
        alias: "string"
      ...
      symbol: /'[^\d\s\\]\w*/
    }), delete d.languages.scala["class-name"], delete d.languages.scala["function"], function (e) {
      var t = ["([\"'])(?:\\\\[^]|\\$\\([^)]+\\)|\\$(?!\\()|`[^`]+`|(?!\\1)[^\\\\`$])*\\1", "<<-?\\s*([\"']?)(\\w+)\\2\\s[^]*?[\r\n]\\3"].join("|");
    ...
    }(d), d.languages.solidity = d.languages.extend("clike", {
      "class-name": {
      ...
      operator: /=>|->|:=|=:|\*\*|\+\+|--|\|\||&&|<<=?|>>=?|[-+*/%^&|<>!=]=?|[~?]/
    }), d.languages.insertBefore("solidity", "keyword", {
    ...
    }), d.languages.insertBefore("solidity", "number", {
      version: {
        pattern: /([<>]=?|\^)\d+\.\d+\.\d+\b/,
        lookbehind: !0,
        alias: "number"
      }
    }), d.languages.sol = d.languages.solidity, function (e) {
      var t = {
    ...
    }, d.languages.trig = d.languages.turtle, d.languages.sparql = d.languages.extend("turtle", {
      "boolean": /\b(?:true|false)\b/i,
      variable: {
        pattern: /[?$]\w+/,
        greedy: !0
      }
    }), d.languages.insertBefore("sparql", "punctuation", {
    ...
    }), d.languages.rq = d.languages.sparql, d.languages["splunk-spl"] = {
      comment: /`comment\("(?:\\.|[^\\"])*"\)`/,
      string: {
        pattern: /"(?:\\.|[^\\"])*"/,
        greedy: !0
      ...
      operator: /[<>=]=?|[-+*/%|]/,
      punctuation: /[()[\],]/
    }, d.languages.sqf = d.languages.extend("clike", {
      string: {
        pattern: /"(?:(?:"")?[^"])*"(?!")|'(?:[^'])*'/,
        greedy: !0
      },
    ...
    }), d.languages.insertBefore("sqf", "string", {
      macro: {
        pattern: /(^\s*)#[a-z](?:[^\r\n\\]|\\(?:\r\n|[\s\S]))*/im,
        lookbehind: !0,
        greedy: !0,
        ...
        inside: {
          ...
          comment: d.languages.sqf.comment
        }
      }
    }), delete d.languages.sqf["class-name"], d.languages.stan = {
      comment: /\/\/.*|\/\*[\s\S]*?\*\/|#(?!include).*/,
      string: {
      ...
      operator: /<-|\.[*/]=?|\|\|?|&&|[!=<>+\-*/]=?|['^%~?:]/,
      punctuation: /[()\[\]{},;]/
    }, d.languages.stan.constraint.inside.expression.inside = d.languages.stan, d.languages.iecst = {
      comment: [{
        pattern: /(^|[^\\])(?:\/\*[\s\S]*?(?:\*\/|$)|\(\*[\s\S]*?(?:\*\)|$)|\{[\s\S]*?(?:\}|$))/,
        lookbehind: !0
      }, {
    ...
    }(d), d.languages.swift = d.languages.extend("clike", {
      string: {
        pattern: /("|')(?:\\(?:\((?:[^()]|\([^)]+\))+\)|\r\n|[^(])|(?!\1)[^\\\r\n])*\1/,
        greedy: !0,
        inside: {
    ...
    }), d.languages.swift.string.inside.interpolation.inside.rest = d.languages.swift, function (e) {
      function t(e, t, n) {
        return {
    ...
    }(d), d.languages.t4 = d.languages["t4-cs"] = d.languages["t4-templating"].createT4("csharp"), d.languages.vbnet = d.languages.extend("basic", {
      comment: [{
        pattern: /(?:!|REM\b).+/i,
        inside: {
          keyword: /^REM/i
    ...
    }), d.languages["t4-vb"] = d.languages["t4-templating"].createT4("vbnet"), function (e) {
      var t = /[*&][^\s[\]{},]+/,
          n = /!(?:<[\w\-%#;/?:@&=+$,.!~*'()[\]]+>|(?:[a-zA-Z\d-]*!)?[\w\-%#;/?:@&=+$.~*'()]+)?/,
      ...
      o.bold.inside = i, o.italic.inside = i, o.inserted.inside = i, o.deleted.inside = i, o.span.inside = i;
      var s = r.table.inside;
      s.inline = i.inline, s.link = i.link, s.image = i.image, s.footnote = i.footnote, s.acronym = i.acronym, s.mark = i.mark;
    }(d), function (e) {
      function t(e) {
      ...
      punctuation: /[()[\]{};,.]/
    }, d.languages.uc = d.languages.uscript = d.languages.unrealscript, d.languages.vala = d.languages.extend("clike", {
      "class-name": [{
    ...
    }), d.languages.insertBefore("vala", "string", {
      "raw-string": {
        pattern: /"""[\s\S]*?"""/,
        greedy: !0,
        alias: "string"
        ...
        inside: {
          interpolation: {
            ...
            inside: {
              ...
              rest: d.languages.vala
            }
          },
          string: /[\s\S]+/
        }
      }
    }), d.languages.insertBefore("vala", "keyword", {
      regex: {
        pattern: /\/(?:\[(?:[^\]\\\r\n]|\\.)*]|\\.|[^/\\\[\r\n])+\/[imsx]{0,4}(?=\s*(?:$|[\r\n,.;})\]]))/,
        greedy: !0,
        inside: {
      ...
      punctuation: /[{}().,:?]/
    }, d.languages.vb = d.languages["visual-basic"], d.languages.vba = d.languages["visual-basic"], d.languages.warpscript = {
      comment: /#.*|\/\/.*|\/\*[\s\S]*?\*\//,
      string: {
        pattern: /"(?:[^"\\\r\n]|\\.)*"|'(?:[^'\\\r\n]|\\.)*'|<'(?:[^\\']|'(?!>)|\\.)*'>/,
        greedy: !0
      ...
      punctuation: /[()]/
    }, d.languages.wiki = d.languages.extend("markup", {
      "block-comment": {
        pattern: /(^|[^\\])\/\*[\s\S]*?\*\//,
        lookbehind: !0,
        alias: "comment"
      ...
      punctuation: /^(?:\{\||\|\}|\|-|[*#:;!|])|\|\||!!/m
    }), d.languages.insertBefore("wiki", "tag", {
      nowiki: {
      ...
      var t = function t(e) {
        ...
        for (var r = [], i = 0; i < a.length; i++) {
          ...
          if ("string" != typeof o && ("tag" === o.type && o.content[0] && "tag" === o.content[0].type ? "</" === o.content[0].content[0].content ? 0 < r.length && r[r.length - 1].tagName === t(o.content[0].content[1]) && r.pop() : "/>" === o.content[o.content.length - 1].content || r.push({
            ...
            var l = t(o);
            i < a.length - 1 && ("string" == typeof a[i + 1] || "plain-text" === a[i + 1].type) && (l += t(a[i + 1]), a.splice(i + 1, 1)), 0 < i && ("string" == typeof a[i - 1] || "plain-text" === a[i - 1].type) && (l = t(a[i - 1]) + l, a.splice(i - 1, 1), i--), /^\s+$/.test(l) ? a[i] = l : a[i] = new e.Token("plain-text", l, null, l);
          }
      ...
      var n = /\b(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)\b/,
          a = "\\b(?!" + n.source + ")(?!\\d)\\w+\\b",
          r = "align\\s*\\((?:[^()]|\\([^()]*\\))*\\)",
          i = "(?!\\s)(?:!?\\s*(?:" + "(?:\\?|\\bpromise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*<ALIGN>|\\s*const\\b|\\s*volatile\\b|\\s*allowzero\\b)*)".replace(/<ALIGN>/g, t(r)) + "\\s*)*" + "(?:\\bpromise\\b|(?:\\berror\\.)?<ID>(?:\\.<ID>)*(?!\\s+<ID>))".replace(/<ID>/g, t(a)) + ")+";
      e.languages.zig = {
        comment: [{
          pattern: /\/{3}.*/,
          alias: "doc-comment"
        ...
        "class-name": [/\b(?!\d)\w+(?=\s*=\s*(?:(?:extern|packed)\s+)?(?:enum|struct|union)\s*[({])/, {
          pattern: RegExp("(:\\s*)<TYPE>(?=\\s*(?:<ALIGN>\\s*)?[=;,)])|<TYPE>(?=\\s*(?:<ALIGN>\\s*)?\\{)".replace(/<TYPE>/g, t(i)).replace(/<ALIGN>/g, t(r))),
          lookbehind: !0,
          inside: null
        }, {
          pattern: RegExp("(\\)\\s*)<TYPE>(?=\\s*(?:<ALIGN>\\s*)?;)".replace(/<TYPE>/g, t(i)).replace(/<ALIGN>/g, t(r))),
          lookbehind: !0,
          inside: null
        }],
        "builtin-types": {
      ...
      function s(e, a, s) {
        var l = (a = "string" == typeof a ? a : e.getAttribute("data-line")).replace(/\s+/g, "").split(",").filter(Boolean),
            c = +e.getAttribute("data-line-offset") || 0,
            p = (t() ? parseInt : parseFloat)(getComputedStyle(e).lineHeight),
            u = i(e, "line-numbers"),
            g = e.querySelector("code"),
            m = u ? e : g || e,
            b = [],
            E = g && m != g ? function (e, t) {
        ...
        l.forEach(function (t) {
          ...
          if (b.push(function () {
            i.setAttribute("aria-hidden", "true"), i.setAttribute("data-range", t), i.className = (s || "") + " line-highlight";
          }), u && d.plugins.lineNumbers) {
            var o = d.plugins.lineNumbers.getLine(e, a),
                l = d.plugins.lineNumbers.getLine(e, r);

            if (o) {
              var g = o.offsetTop + E + "px";
              b.push(function () {
                i.style.top = g;
              });
            }
            ...
            if (l) {
              var f = l.offsetTop - o.offsetTop + l.offsetHeight + "px";
              b.push(function () {
                i.style.height = f;
              });
            }
          } else b.push(function () {
            i.setAttribute("data-start", String(a)), a < r && i.setAttribute("data-end", String(r)), i.style.top = (a - c - 1) * p + E + "px", i.textContent = new Array(r - a + 2).join(" \n");
          });
        ...
        if (u && f) {
          for (var h = "linkable-line-numbers", S = !1, T = e; T;) {
            if (i(T, h)) {
              S = !0;
              break;
            }
          ...
          if (S) {
            i(e, h) || b.push(function () {
              e.className = (e.className + " " + h).trim();
            });
            var A = parseInt(e.getAttribute("data-start") || "1");
      ...
      function l() {
        ...
        if (t && !document.getElementById(e)) {
          ...
          i && (i.hasAttribute("data-line") || i.setAttribute("data-line", ""), s(i, t, "temporary ")(), n && document.querySelector(".temporary.line-highlight").scrollIntoView());
        }
      }
    }(), function () {
      if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        window.addEventListener("resize", function () {
          n.assumeViewportIndependence && r === window.innerWidth || (r = window.innerWidth, i(Array.prototype.slice.call(document.querySelectorAll("pre." + e))));
        }), d.hooks.add("complete", function (n) {
          if (n.code) {
            var a = n.element,
                r = a.parentNode;

            if (r && /pre/i.test(r.nodeName) && !a.querySelector(".line-numbers-rows") && d.util.isActive(a, e)) {
              a.classList.remove(e), r.classList.add(e);
              var o,
                  s = n.code.match(t),
                  l = s ? s.length + 1 : 1,
                  c = new Array(l + 1).join("<span></span>");
              (o = document.createElement("span")).setAttribute("aria-hidden", "true"), o.className = "line-numbers-rows", o.innerHTML = c, r.hasAttribute("data-start") && (r.style.counterReset = "linenumber " + (parseInt(r.getAttribute("data-start"), 10) - 1)), n.element.appendChild(o), i([r]), d.hooks.run("line-numbers", n);
            }
          }
      ...
      if (("undefined" == typeof self || self.Prism) && (void 0 === n.g || n.g.Prism)) {
        var e = /\b([a-z]{3,7}:\/\/|tel:)[\w\-+%~/.:=&@]+(?:\?[\w\-+%~/.:=?&!$'()*,;@]*)?(?:#[\w\-+%~/.:#=?&!$'()*,;@]*)?/,
            t = /\b\S+@[\w.]+[a-z]{2}/,
            a = /\[([^\]]+)]\(([^)]+)\)/,
            r = ["comment", "url", "attr-value", "string"];
        d.plugins.autolinker = {
          processGrammar: function processGrammar(n) {
            n && !n["url-link"] && (d.languages.DFS(n, function (n, i, o) {
              -1 < r.indexOf(o) && !Array.isArray(i) && (i.pattern || (i = this[n] = {
                pattern: i
              }), i.inside = i.inside || {}, "comment" == o && (i.inside["md-link"] = a), "attr-value" == o ? d.languages.insertBefore("inside", "punctuation", {
                "url-link": e
              }, i) : i.inside["url-link"] = e, i.inside["email-link"] = t);
            }), n["url-link"] = e, n["email-link"] = t);
          }
        }, d.hooks.add("before-highlight", function (e) {
          d.plugins.autolinker.processGrammar(e.grammar);
        }), d.hooks.add("wrap", function (e) {
          if (/-link$/.test(e.type)) {
            e.tag = "a";
            var t = e.content;
            if ("email-link" == e.type && 0 != t.indexOf("mailto:")) t = "mailto:" + t;else if ("md-link" == e.type) {
              var n = e.content.match(a);
              t = n[2], e.content = n[1];
            }
            e.attributes.href = t;
      ...
      if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        var e = window.Prism,
          ...
          tex: "latex"
            ...
            a = "loading",
            r = "loaded",
            i = "pre[data-src]:not([" + n + '="' + r + '"]):not([' + n + '="' + a + '"])',
            o = /\blang(?:uage)?-([\w-]+)\b/i;
        e.hooks.add("before-highlightall", function (e) {
          ...
          if (s.matches(i)) {
            ...
            m.open("GET", c, !0), m.onreadystatechange = function () {
              4 == m.readyState && (m.status < 400 && m.responseText ? (s.setAttribute(n, r), d.textContent = m.responseText, e.highlightElement(d)) : (s.setAttribute(n, "failed"), 400 <= m.status ? d.textContent = function (e, t) {
                return "✖ Error " + e + " while fetching file: " + t;
              }(m.status, m.statusText) : d.textContent = "✖ Error: File does not exist or is empty"));
            }, m.send(null);
          }
        });
        var s = !(e.plugins.fileHighlight = {
    ...
    }(), "undefined" != typeof self && self.Prism && self.document && d.hooks.add("before-sanity-check", function (e) {
      if (e.code) {
      ...
      if ("undefined" != typeof self && void 0 !== d && "undefined" != typeof document) {
        var e = /<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/g,
          ...
          if (n) {
            for (var a = 6 <= (e = n[1]).length ? 2 : 1, r = e.length / a, i = 1 == a ? 1 / 15 : 1 / 255, o = [], s = 0; s < r; s++) {
              var l = parseInt(e.substr(s * a, a), 16);
              o.push(l * i);
            }

            return 3 == r && o.push(1), "rgba(" + o.slice(0, 3).map(function (e) {
              return String(Math.round(255 * e));
            }).join(",") + "," + String(Number(o[3].toFixed(3))) + ")";
          }
        }, function (e) {
          var t = new Option().style;
          return t.color = e, t.color ? e : void 0;
        }];
        d.hooks.add("wrap", function (t) {
          if ("color" === t.type || 0 <= t.classes.indexOf("color")) {
            for (var a, r = t.content, i = r.split(e).join(""), o = 0, s = n.length; o < s && !a; o++) {
              a = n[o](i);
            }

            if (!a) return;
            var l = '<span class="inline-color-wrapper"><span class="inline-color" style="background-color:' + a + ';"></span></span>';
            t.content = l + r;
          }
        });
      }
      ...
      if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
        var e = {
          ...
          yml: "yaml"
            ...
            n = {},
            a = "components/",
            r = d.util.currentScript();

        if (r) {
          var i = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
              o = /(^|\/)[\w-]+\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
              s = r.getAttribute("data-autoloader-path");
          if (null != s) a = s.trim().replace(/\/?$/, "/");else {
            var l = r.src;
            i.test(l) ? a = l.replace(i, "components/") : o.test(l) && (a = l.replace(o, "$1components/"));
          }
        }

        var c = d.plugins.autoloader = {
          languages_path: a,
          use_minified: !0,
          loadLanguages: u
        };
        d.hooks.add("complete", function (e) {
          var t = e.element,
              n = e.language;
          ...
          if (t && n && "none" !== n) {
            ...
            /^diff-./i.test(n) ? (a.push("diff"), a.push(n.substr("diff-".length))) : a.push(n), a.every(p) || u(a, function () {
      ...
      function p(e) {
        ...
        if ((e = t[e] || e) in d.languages) return !0;
        var a = n[e];
          ...
          !function (a, r, i) {
            ...
            function s() {
              ...
              e || (e = n[a] = {
                ...
                success: r,
                error: i
              }), !o && p(a) ? g(a, "success") : !o && e.error ? g(a, "error") : !o && e.loading || (e.loading = !0, e.error = !1, function (e, t, n) {
                ...
                e.loading = !1, g(a, "success");
              }, function () {
                e.loading = !1, e.error = !0, g(a, "error");
              }));
            }

            a = a.replace("!", ""), a = t[a] || a;
            var l = e[a];
            l && l.length ? u(l, s, i) : s();
          }(a, d, function () {
            l || (l = !0, i && i(a));
          });
        }) : r && setTimeout(r, 0);
      ...
      function g(e, t) {
        if (n[e]) {
          for (var a = n[e].callbacks, r = 0, i = a.length; r < i; r++) {
            var o = a[r][t];
            o && setTimeout(o, 0);
          }
    ...
    }(), "undefined" != typeof self && self.Prism && self.document && document.createRange && (d.plugins.KeepMarkup = !0, d.hooks.add("before-highlight", function (e) {
      if (e.element.children.length && d.util.isActive(e.element, "keep-markup", !0)) {
        var t = 0,
            n = [],
            a = function a(e, r) {
          var i = {};
    ...
    }), d.hooks.add("after-highlight", function (e) {
      if (e.keepMarkup && e.keepMarkup.length) {
        var t = function t(e, n) {
          for (var a = 0, r = e.childNodes.length; a < r; a++) {
            ...
            if (n.nodeStart && n.nodeEnd) {
              ...
              return o.setStart(n.nodeStart, n.nodeStartPos), o.setEnd(n.nodeEnd, n.nodeEndPos), n.node.clone.appendChild(o.extractContents()), o.insertNode(n.node.clone), o.detach(), !1;
            }
          }
    ...
    })), "undefined" != typeof self && self.Prism && self.document && (Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), d.plugins.UnescapedMarkup = !0, d.hooks.add("before-highlightall", function (e) {
      ...
      if (t.matches('script[type="text/plain"]')) {
        ...
        a.className = n.className = t.className;
        var r = t.dataset;
        return Object.keys(r || {}).forEach(function (e) {
          Object.prototype.hasOwnProperty.call(r, e) && (a.dataset[e] = r[e]);
        }), n.textContent = e.code = e.code.replace(/&lt;\/script(?:>|&gt;)/gi, "<\/script>"), a.appendChild(n), t.parentNode.replaceChild(a, t), void (e.element = n);
      }
      ...
      n.prototype = {
        ...
        breakLines: function breakLines(e, t) {
          ...
          for (var n = e.split("\n"), r = 0; r < n.length; ++r) {
            if (!(a(n[r]) <= t)) {
              for (var i = n[r].split(/(\s+)/g), o = 0, s = 0; s < i.length; ++s) {
                var l = a(i[s]);
                t < (o += l) && (i[s] = "\n" + i[s], o = l);
              }
      ...
      }, e.exports && (e.exports = n), void 0 !== d && (d.plugins.NormalizeWhitespace = new n({
        "remove-trailing": !0,
        "remove-indent": !0,
        "left-trim": !0,
        "right-trim": !0
      }), d.hooks.add("before-sanity-check", function (e) {
        var t = d.plugins.NormalizeWhitespace;
        if ((!e.settings || !1 !== e.settings["whitespace-normalization"]) && d.util.isActive(e.element, "whitespace-normalization", !0)) if (e.element && e.element.parentNode || !e.code) {
          var n = e.element.parentNode;

          if (e.code && n && "pre" === n.nodeName.toLowerCase()) {
            for (var a = n.childNodes, r = "", i = "", o = !1, s = 0; s < a.length; ++s) {
              var l = a[s];
              l == e.element ? o = !0 : "#text" === l.nodeName && (o ? i += l.nodeValue : r += l.nodeValue, n.removeChild(l), --s);
            }

            if (e.element.children.length && d.plugins.KeepMarkup) {
              var c = r + e.element.innerHTML + i;
  ...
  n.g = function () {
    ...
    ["prism"].forEach(function (e) {
      return n(1)("./" + e);
    }), document.querySelectorAll("[_code]").forEach(function (t) {
      {
        var _n = t.attributes._code.value;
        t.classList.add("language-" + _n), "code" === t.localName ? e(t) : "pre" === t.localName && void 0 !== t.childNodes[0] && ("code" !== t.childNodes[0].localName && (t.innerHTML = "<code>" + t.innerHTML.trim() + "</code>"), e(t.childNodes[0]));
      }
    });
  }();
})();