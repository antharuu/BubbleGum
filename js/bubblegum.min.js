(() => {
    var e = [, (e, t, n) => {
        ...
        var a, r, i, o, s, l, d = function (e) {
            var t = /\blang(?:uage)?-([\w-]+)\b/i, n = 0, a = {
                ...
                highlightElement: function (n, r, i) {
                    var o = a.util.getLanguage(n), s = a.languages[o];
                    ...
                    if (a.hooks.run("before-highlight", d), d.grammar) if (r && e.Worker) {
                        var p = new Worker(a.filename);
                        p.onmessage = function (e) {
                            c(e.data)
                        }, p.postMessage(JSON.stringify({language: d.language, code: d.code, immediateClose: !0}))
                    } else c(a.highlight(d.code, d.grammar, d.language)); else c(a.util.encode(d.code))
                },
                    ...
                    return s(c, c.head, e), function e(t, n, o, d, c, p) {
                        for (var u in o) if (o.hasOwnProperty(u) && o[u]) {
                            ...
                            for (var m = 0; m < g.length; ++m) {
                                ...
                                var b = g[m], E = b.inside, f = !!b.lookbehind, h = !!b.greedy, S = b.alias;
                                ...
                                for (var A = b.pattern || b, _ = d.next, y = c; _ !== n.tail && !(p && y >= p.reach); y += _.value.length, _ = _.next) {
                                    ...
                                    if (!(R instanceof r)) {
                                        ...
                                        if (h) {
                                            ...
                                            var k = I.index, w = I.index + I[0].length, C = y;
                                            for (C += _.value.length; C <= k;) C += (_ = _.next).value.length;
                                            if (y = C -= _.value.length, _.value instanceof r) continue;
                                            for (var v = _; v !== n.tail && (C < w || "string" == typeof v.value); v = v.next) N++, C += v.value.length;
                                            N--, R = t.slice(y, C), I.index -= y
                                        } else if (!(I = i(A, 0, R, f))) continue;
                                        k = I.index;
                                        var O = I[0], L = R.slice(0, k), D = R.slice(k + O.length), x = y + R.length;
            ...
            if (e.Prism = a, r.stringify = function e(t, n) {
                ...
                var n = JSON.parse(t.data), r = n.language, i = n.code, o = n.immediateClose;
        ...
        e.exports && (e.exports = d), void 0 !== n.g && (n.g.Prism = d), d.languages.markup = {
            ...
            value: function (e, t) {
                ...
                a["language-" + t] = {pattern: /[\s\S]+/, inside: d.languages[t]};
                var r = {};
                r[e] = {
            ...
            e.languages.apex = {
                ...
                "class-name": [{
                    ...
                    lookbehind: !0,
                    inside: r
                }, {pattern: a("<CLASS-NAME>(?=\\s*\\w+\\s*[;=,(){:])"), inside: r}],
            ...
            macro: {
                ...
                alias: "property",
                inside: {
                    string: [{pattern: /^(#\s*include\s*)<[^>]+>/, lookbehind: !0}, d.languages.c.string],
        ...
        }), r.languages.insertBefore("inside", "operator", {"class-name": /\b[a-z_]\w*\b(?!\s*::)/i}, r.languages.cpp["base-clause"]), d.languages.arduino = d.languages.extend("cpp", {
            ...
            var d = l(i), c = RegExp(l(r + " " + i + " " + o + " " + s)), p = l(i + " " + o + " " + s),
                u = l(r + " " + i + " " + s), g = a("<(?:[^<>;=+\\-*/%&|^]|<<self>>)*>", 2),
                m = a("\\((?:[^()]|<<self>>)*\\)", 2), b = "@?\\b[A-Za-z_]\\w*\\b",
                E = t("<<0>>(?:\\s*<<1>>)?", [b, g]), f = t("(?!<<0>>)<<1>>(?:\\s*\\.\\s*<<1>>)*", [p, E]),
                h = "\\[\\s*(?:,\\s*)*\\]", S = t("<<0>>(?:\\s*(?:\\?\\s*)?<<1>>)*(?:\\s*\\?)?", [f, h]),
                T = t("(?:<<0>>|<<1>>)(?:\\s*(?:\\?\\s*)?<<2>>)*(?:\\s*\\?)?", [t("\\(<<0>>+(?:,<<0>>+)+\\)", [t("[^,()<>[\\];=+\\-*/%&|^]|<<0>>|<<1>>|<<2>>", [g, m, h])]), f, h]),
                A = {keyword: c, punctuation: /[<>()?,.:[\]]/},
                _ = "'(?:[^\r\n'\\\\]|\\\\.|\\\\[Uux][\\da-fA-F]{1,8})'", y = '"(?:\\\\.|[^\\\\"\r\n])*"';
            e.languages.csharp = e.languages.extend("clike", {
                string: [{
                    ...
                    lookbehind: !0,
                    greedy: !0
                }, {pattern: n("(^|[^@$\\\\])<<0>>", [y]), lookbehind: !0, greedy: !0}, {
                    pattern: RegExp(_),
                    greedy: !0,
                    alias: "character"
                }],
                ...
                "generic-method": {
                    ...
                    inside: {function: n("^<<0>>", [b]), generic: {pattern: RegExp(g), alias: "class-name", inside: A}}
                },
                "type-list": {
                    pattern: n("\\b((?:<<0>>\\s+<<1>>|where\\s+<<2>>)\\s*:\\s*)(?:<<3>>|<<4>>)(?:\\s*,\\s*(?:<<3>>|<<4>>))*(?=\\s*(?:where|[{;]|=>|$))", [d, E, b, T, c.source]),
                    lookbehind: !0,
                    inside: {keyword: c, "class-name": {pattern: RegExp(T), greedy: !0, inside: A}, punctuation: /,/}
                },
                preprocessor: {
                    pattern: /(^\s*)#.*/m,
                    lookbehind: !0,
            ...
            e.languages.insertBefore("csharp", "class-name", {
                attribute: {
                    ...
                    greedy: !0,
                    inside: {
                        target: {pattern: n("^<<0>>(?=\\s*:)", [k]), alias: "keyword"},
                        "attribute-arguments": {pattern: n("\\(<<0>>*\\)", [N]), inside: e.languages.csharp},
            ...
            directive: {
                pattern: /<%.*%>/i,
                alias: "tag",
                inside: {directive: {pattern: /<%\s*?[$=%#:]{0,2}|%>/i, alias: "tag"}, rest: d.languages.csharp}
            }
        }), d.languages.aspnet.tag.pattern = /<(?!%)\/?[^\s>\/]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|[^\s'">=]+))?)*\s*\/?>/i, d.languages.insertBefore("inside", "punctuation", {directive: d.languages.aspnet.directive}, d.languages.aspnet.tag.inside["attr-value"]), d.languages.insertBefore("aspnet", "comment", {
            "asp-comment": {
                pattern: /<%--[\s\S]*?--%>/,
                alias: ["asp", "comment"]
            }
        ...
        }), d.languages.insertBefore("d", "keyword", {property: /\B@\w*/}), d.languages.insertBefore("d", "function", {
            register: {
                            ...
                            !function o(s) {
                                for (var l = 0; l < s.length && !(r >= i.length); l++) {
                                    ...
                                    if ("string" == typeof d || d.content && "string" == typeof d.content) {
                                        var c = i[r], p = n.tokenStack[c], u = "string" == typeof d ? d : d.content,
                                            g = t(a, c), m = u.indexOf(g);
                                        if (-1 < m) {
                                            ++r;
                                            var b = u.substring(0, m),
                                                E = new e.Token(a, e.tokenize(p, n.grammar), "language-" + a, p),
                                                f = u.substring(m + g.length), h = [];
            ...
            e.inside = {
                interpolation: {
                    pattern: /#\{[^}]+\}/,
                    inside: {delimiter: {pattern: /^#\{|\}$/, alias: "punctuation"}, rest: d.languages.elixir}
                }
            }
        })),d.languages.elm = {
            comment: /--.*|{-[\s\S]*?-}/,
            ...
            annotation: {
                ...
                inside: {
                    ...
                    "annotation-content": {pattern: /[\s\S]+/, inside: d.languages.fsharp}
                }
            }
        }),function (e) {
            ...
            a.string[1].inside.interpolation.inside.rest = a, e.languages.ftl = {
                ...
                "ftl-interpolation": {
                    pattern: /^\$\{[\s\S]*\}$/,
                    inside: {punctuation: /^\$\{|\}$/, content: {pattern: /\s*\S[\s\S]*/, alias: "ftl", inside: a}}
                }
        ...
        }),d.languages.insertBefore("groovy", "punctuation", {"spock-block": /\b(?:setup|given|when|then|and|cleanup|expect|where):/}),d.languages.insertBefore("groovy", "function", {
            annotation: {
                pattern: /(^|[^.])@\w+/,
                lookbehind: !0,
                alias: "punctuation"
            ...
            e.languages.insertBefore("php", "variable", {string: s}), e.languages.insertBefore("php", "variable", {
                attribute: {
            ...
            Object.defineProperty(t, "addSupport", {
                value: function (t, n) {
                    "string" == typeof t && (t = [t]), t.forEach((function (t) {
                        !function (t, n) {
                            var a = "doc-comment", r = e.languages[t];
                            if (r) {
                                var i = r[a];
                                if (!i) {
                                ...
                                if (i instanceof RegExp && (i = r[a] = {pattern: i}), Array.isArray(i)) for (var o = 0, s = i.length; o < s; o++) i[o] instanceof RegExp && (i[o] = {pattern: i[o]}), n(i[o]); else n(i)
                            }
                        }(t, (function (e) {
            ...
            var t = "\\\\\\((?:[^()]|\\([^()]*\\))*\\)",
                n = RegExp('"(?:[^"\r\n\\\\]|\\\\[^\r\n(]|__)*"'.replace(/__/g, (function () {
                    ...
                    comment: /#.*/,
                    property: {pattern: RegExp(n.source + "(?=\\s*:(?!:))"), greedy: !0, inside: a},
            ...
            for (var n = ["function", "function-variable", "method", "method-variable", "property-access"], a = 0; a < n.length; a++) {
                var r = n[a], i = e.languages.javascript[r];
        ...
        }(d),d.languages.jsonp = d.languages.extend("json", {punctuation: /[{}[\]();,.]/}),d.languages.insertBefore("jsonp", "punctuation", {function: /(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*\()/}),d.languages.jsstacktrace = {
            "error-message": {
                pattern: /^\S.*/m,
                alias: "string"
            },
            ...
            var t = e.languages.javascript["template-string"], n = t.pattern.source, a = t.inside.interpolation,
                r = a.inside["interpolation-punctuation"], i = a.pattern.source;
            ...
            function d(t, n, a) {
                var r = e.tokenize(t, {interpolation: {pattern: RegExp(i), lookbehind: !0}}), o = 0, d = {},
                    c = s(r.map((function (e) {
                        if ("string" == typeof e) return e;
                        for (var n, r = e.content; -1 !== t.indexOf((i = o++, n = "___" + a.toUpperCase() + "_" + i + "___"));) ;
                        return d[n] = r, n;
                        var i
                    })).join(""), n, a), p = Object.keys(d);
                return o = 0, function e(t) {
                    for (var n = 0; n < t.length; n++) {
                        if (o >= p.length) return;
                        var a = t[n];
                        if ("string" == typeof a || "string" == typeof a.content) {
                            var r = p[o], i = "string" == typeof a ? a : a.content, s = i.indexOf(r);
                            if (-1 !== s) {
                                ++o;
                                var c = i.substring(0, s), u = l(d[r]), g = i.substring(s + r.length), m = [];
                        ...
                        if ("string" != typeof i) {
                            ...
                            if (Array.isArray(o)) if ("template-string" === i.type) {
                                ...
                                if (3 === o.length && "string" != typeof s && "embedded-code" === s.type) {
                                    var l = p(s), c = s.alias, u = Array.isArray(c) ? c[0] : c, g = e.languages[u];
                                    if (!g) continue;
                                    o[1] = d(l, g, u)
                                }
            ...
            e.languages.kotlin.string.inside = e.languages.kotlin["raw-string"].inside = {interpolation: t}, e.languages.kt = e.languages.kotlin, e.languages.kts = e.languages.kotlin
        }(d),function (e) {
            ...
            e.languages.latte = {
                ...
                php: {pattern: /\S(?:[\s\S]*\S)?/, alias: "language-php", inside: e.languages.php}
            };
            ...
            var a = "[-+*/_~!@$%^=<>{}\\w]+", r = "(\\()", i = "(?=\\))", o = "(?=\\s)", s = {
                ...
                keyword: [{
                    ...
                    lookbehind: !0
                }, {pattern: RegExp(r + "(?:for|do|collect|return|finally|append|concat|in|by)" + o), lookbehind: !0}],
                ...
                car: {pattern: RegExp(r + a), lookbehind: !0},
                ...
                lookbehind: !0,
                inside: {
                    "rest-vars": {pattern: RegExp("&(?:rest|body)\\s+" + d), inside: l},
                    "other-marker-vars": {pattern: RegExp("&(?:optional|aux)\\s+" + d), inside: l},
                    keys: {pattern: RegExp("&key\\s+" + d + "(?:\\s+&allow-other-keys)?"), inside: l},
                    argument: {pattern: RegExp(a), alias: "variable"},
                    punctuation: /[()]/
                }
            };
            ...
            e.languages.markdown = e.languages.extend("markup", {}), e.languages.insertBefore("markdown", "prolog", {
                ...
                if ("code-block" === t.type) {
                    for (var n = "", a = 0, r = t.classes.length; a < r; a++) {
                        var i = t.classes[a], o = /language-(.+)/.exec(i);
                        if (o) {
                            n = o[1];
                            break
                        }
            ...
            punctuation: /[;[\](),.{}:]/
        },d.languages.n4js = d.languages.extend("javascript", {keyword: /\b(?:any|Array|boolean|break|case|catch|class|const|constructor|continue|debugger|declare|default|delete|do|else|enum|export|extends|false|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|module|new|null|number|package|private|protected|public|return|set|static|string|super|switch|this|throw|true|try|typeof|var|void|while|with|yield)\b/}),d.languages.insertBefore("n4js", "constant", {
            annotation: {
                pattern: /@+\w+/,
                alias: "operator"
            }
            ...
            var t = /\{[^\r\n\[\]{}]*\}/, n = {
                ...
                "command-param-value": [{pattern: t, alias: "selector"}, {
                    pattern: /([\t ])\S+/,
                    lookbehind: !0,
                    greedy: !0,
                    alias: "operator"
        ...
        }),d.languages.insertBefore("nginx", "keyword", {variable: /\$[a-z_]+/i}),d.languages.nim = {
            comment: /#.*/,
            string: {
            ...
            var t = e.languages.plsql = e.languages.extend("sql", {comment: [/\/\*[\s\S]*?\*\//, /--.*/]}),
                n = t.keyword;
            ...
            var t = {pattern: /(^[ \t]*| {2}|\t)#.*/m, lookbehind: !0, greedy: !0}, n = {
                pattern: /((?:^|[^\\])(?:\\{2})*)[$@&%]\{(?:[^{}\r\n]|\{[^{}\r\n]*\})*\}/,
                lookbehind: !0,
                inside: {punctuation: /^[$@&%]\{|\}$/}
            };
            ...
            var t = "(?:\"(?:\"\"|[^\"])*\"(?!\")|'(?:''|[^'])*'(?!'))",
                ...
                a = {pattern: RegExp(t + "[bx]"), alias: "number"}, r = {pattern: /&[a-z_][a-z_0-9]*/i}, i = {
                    pattern: /((?:^|\s|=|\())%(?:ABORT|BY|CMS|COPY|DISPLAY|DO|ELSE|END|EVAL|GLOBAL|GO|GOTO|IF|INC|INCLUDE|INDEX|INPUT|KTRIM|LENGTH|LET|LIST|LOCAL|PUT|QKTRIM|QSCAN|QSUBSTR|QSYSFUNC|QUPCASE|RETURN|RUN|SCAN|SUBSTR|SUPERQ|SYMDEL|SYMGLOBL|SYMLOCAL|SYMEXIST|SYSCALL|SYSEVALF|SYSEXEC|SYSFUNC|SYSGET|SYSRPUT|THEN|TO|TSO|UNQUOTE|UNTIL|UPCASE|WHILE|WINDOW)\b/i,
                    lookbehind: !0,
                    alias: "keyword"
                }, o = {pattern: /(^|\s+)(?:proc\s+\w+|quit|run|data(?!\=))\b/i, alias: "keyword", lookbehind: !0},
                s = [/\/\*[\s\S]*?\*\//, {pattern: /(^\s*|;\s*)\*[^;]*;/m, lookbehind: !0}],
                l = {pattern: RegExp(t), greedy: !0}, d = /[$%@.(){}\[\];,\\]/,
                c = {pattern: /%?\w+(?=\()/, alias: "keyword"}, p = {
                    function: c,
        ...
        }),d.languages.insertBefore("scss", "important", {variable: /\$[-\w]+|#\{\$[-\w]+\}/}),d.languages.insertBefore("scss", "function", {
            "module-modifier": {
            ...
            operator: /=>|->|:=|=:|\*\*|\+\+|--|\|\||&&|<<=?|>>=?|[-+*/%^&|<>!=]=?|[~?]/
        }),d.languages.insertBefore("solidity", "keyword", {builtin: /\b(?:address|bool|string|u?int(?:8|16|24|32|40|48|56|64|72|80|88|96|104|112|120|128|136|144|152|160|168|176|184|192|200|208|216|224|232|240|248|256)?|byte|bytes(?:[1-9]|[12]\d|3[0-2])?)\b/}),d.languages.insertBefore("solidity", "number", {
            version: {
                pattern: /([<>]=?|\^)\d+\.\d+\.\d+\b/,
                lookbehind: !0,
                alias: "number"
        ...
        }),d.languages.insertBefore("sparql", "punctuation", {keyword: [/\b(?:A|ADD|ALL|AS|ASC|ASK|BNODE|BY|CLEAR|CONSTRUCT|COPY|CREATE|DATA|DEFAULT|DELETE|DESC|DESCRIBE|DISTINCT|DROP|EXISTS|FILTER|FROM|GROUP|HAVING|INSERT|INTO|LIMIT|LOAD|MINUS|MOVE|NAMED|NOT|NOW|OFFSET|OPTIONAL|ORDER|RAND|REDUCED|SELECT|SEPARATOR|SERVICE|SILENT|STRUUID|UNION|USING|UUID|VALUES|WHERE)\b/i, /\b(?:ABS|AVG|BIND|BOUND|CEIL|COALESCE|CONCAT|CONTAINS|COUNT|DATATYPE|DAY|ENCODE_FOR_URI|FLOOR|GROUP_CONCAT|HOURS|IF|IRI|isBLANK|isIRI|isLITERAL|isNUMERIC|isURI|LANG|LANGMATCHES|LCASE|MAX|MD5|MIN|MINUTES|MONTH|ROUND|REGEX|REPLACE|sameTerm|SAMPLE|SECONDS|SHA1|SHA256|SHA384|SHA512|STR|STRAFTER|STRBEFORE|STRDT|STRENDS|STRLANG|STRLEN|STRSTARTS|SUBSTR|SUM|TIMEZONE|TZ|UCASE|URI|YEAR)\b(?=\s*\()/i, /\b(?:GRAPH|BASE|PREFIX)\b/i]}),d.languages.rq = d.languages.sparql,d.languages["splunk-spl"] = {
            comment: /`comment\("(?:\\.|[^\\"])*"\)`/,
            string: {pattern: /"(?:\\.|[^\\"])*"/, greedy: !0},
            ...
            macro: {
                ...
                greedy: !0,
                alias: "property",
                inside: {directive: {pattern: /#[a-z]+\b/i, alias: "keyword"}, comment: d.languages.sqf.comment}
            }
            ...
            var t = {pattern: /(\b\d+)(?:%|[a-z]+)/, lookbehind: !0},
                n = {pattern: /(^|[^\w.-])-?(?:\d+(?:\.\d+)?|\.\d+)/, lookbehind: !0}, a = {
                    comment: {pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/, lookbehind: !0},
            ...
            }, a.func = {pattern: /[\w-]+\([^)]*\).*/, inside: {function: /^[^(]+/, rest: a}}, e.languages.stylus = {
            ...
            e.languages["t4-templating"] = Object.defineProperty({}, "createT4", {
                value: function (n) {
                    var a = e.languages[n], r = "language-" + n;
                    return {
                        block: {
                            pattern: /<#[\s\S]+?#>/,
                            inside: {
                                ...
                                }), expression: t("=", a, r), "class-feature": t("\\+", a, r), standard: t("", a, r)
                            }
                        }
                    }
                }
                ...
                phrase: {
                    pattern: /(^|\r|\n)\S[\s\S]*?(?=$|\r?\n\r?\n|\r\r)/, lookbehind: !0, inside: {
                        ...
                        list: {
                            pattern: t("^[*#]+<MOD>*\\s+\\S.*", "m"),
                            inside: {
                                modifier: {pattern: t("(^[*#]+)<MOD>+"), lookbehind: !0, inside: n},
                                punctuation: /^[*#]+/
                            }
                        },
                        table: {
                        ...
                        inline: {
                            ...
                            lookbehind: !0,
                            inside: {
                                bold: {pattern: t("(^(\\*\\*?)<MOD>*).+?(?=\\2)"), lookbehind: !0},
                                italic: {pattern: t("(^(__?)<MOD>*).+?(?=\\2)"), lookbehind: !0},
                                cite: {pattern: t("(^\\?\\?<MOD>*).+?(?=\\?\\?)"), lookbehind: !0, alias: "string"},
                                code: {pattern: t("(^@<MOD>*).+?(?=@)"), lookbehind: !0, alias: "keyword"},
                                inserted: {pattern: t("(^\\+<MOD>*).+?(?=\\+)"), lookbehind: !0},
                                deleted: {pattern: t("(^-<MOD>*).+?(?=-)"), lookbehind: !0},
                                span: {pattern: t("(^%<MOD>*).+?(?=%)"), lookbehind: !0},
                                modifier: {
                                    pattern: t("(^\\*\\*|__|\\?\\?|[*_%@+\\-^~])<MOD>+"),
                                    lookbehind: !0,
                                    inside: n
                        ...
                        link: {
                            pattern: t('"<MOD>*[^"]+":.+?(?=[^\\w/]?(?:\\s|$))'),
                            inside: {
                                text: {pattern: t('(^"<MOD>*)[^"]+(?=")'), lookbehind: !0},
                                modifier: {pattern: t('(^")<MOD>+'), lookbehind: !0, inside: n},
                        ...
                        image: {
                            ...
                            inside: {
                                ...
                                modifier: {pattern: t("(^!)(?:<MOD>|<PAR>|[<>=])+"), lookbehind: !0, inside: n},
                                url: {pattern: /(:).+/, lookbehind: !0},
                                punctuation: /[!:]/
                            }
                        },
            ...
            other: {pattern: /\S(?:[\s\S]*\S)?/, inside: d.languages.markup}
        },function (e) {
            ...
            e.languages.typoscript = {
                ...
                string: {
                    pattern: /^([^=]*=[< ]?)(?:(?!]\n).)*/,
                    lookbehind: !0,
                    inside: {function: /{\$.*}/, keyword: t, number: /^[0-9]+$/, punctuation: /[,|:]/}
                },
                keyword: t,
            ...
            "template-string": {
                ...
                inside: {
                    interpolation: {
                        pattern: /\$(?:\([^)]*\)|[a-zA-Z]\w*)/,
                        inside: {delimiter: {pattern: /^\$\(?|\)$/, alias: "punctuation"}, rest: d.languages.vala}
                    }, string: /[\s\S]+/
                }
            }
            ...
            "table-tag": {
                pattern: /((?:^|[|!])[|!])[^|\r\n]+\|(?!\|)/m,
                lookbehind: !0,
                inside: {"table-bar": {pattern: /\|$/, alias: "punctuation"}, rest: d.languages.markup.tag.inside}
            },
            punctuation: /^(?:\{\||\|\}|\|-|[*#:;!|])|\|\||!!/m
            ...
            var n = e.languages.markup.tag, a = {pattern: /\/\/\/.*/, greedy: !0, alias: "comment", inside: {tag: n}},
            ...
            if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
                ...
                d.hooks.add("before-sanity-check", (function (e) {
                    var t = e.element.parentElement, n = t && t.getAttribute("data-line");
                    ...
                    var n = t.element.parentElement, r = n && n.getAttribute("data-line");
                    if (n && r && /pre/i.test(n.nodeName)) {
                        clearTimeout(a);
                        var o = d.plugins.lineNumbers, c = t.plugins && t.plugins.lineNumbers;
            ...
            function s(e, a, s) {
                var l = (a = "string" == typeof a ? a : e.getAttribute("data-line")).replace(/\s+/g, "").split(",").filter(Boolean),
                    ...
                    p = (t() ? parseInt : parseFloat)(getComputedStyle(e).lineHeight), u = i(e, "line-numbers"),
                    g = e.querySelector("code"), m = u ? e : g || e, b = [], E = g && m != g ? function (e, t) {
                        var n = getComputedStyle(e), a = getComputedStyle(t);
                ...
                l.forEach((function (t) {
                    ...
                    if (b.push((function () {
                        ...
                        var o = d.plugins.lineNumbers.getLine(e, a), l = d.plugins.lineNumbers.getLine(e, r);
                        if (o) {
            ...
            function l() {
                ...
                if (t && !document.getElementById(e)) {
                    var a = e.slice(0, e.lastIndexOf(".")), i = document.getElementById(a);
            ...
            function i(e) {
                if (0 != (e = e.filter((function (e) {
                    ...
                    var n = e.map((function (e) {
                        var n = e.querySelector("code"), a = e.querySelector(".line-numbers-rows");
                        if (n && a) {
                            var r = e.querySelector(".line-numbers-sizer"), i = n.textContent.split(t);
                    ...
                    n.forEach((function (e) {
                        var t = e.sizer, n = e.lines, a = e.lineHeights, r = e.oneLinerHeight;
                ...
                d.plugins.autolinker = {
                    processGrammar: function (n) {
                        n && !n["url-link"] && (d.languages.DFS(n, (function (n, i, o) {
                            -1 < r.indexOf(o) && !Array.isArray(i) && (i.pattern || (i = this[n] = {pattern: i}), i.inside = i.inside || {}, "comment" == o && (i.inside["md-link"] = a), "attr-value" == o ? d.languages.insertBefore("inside", "punctuation", {"url-link": e}, i) : i.inside["url-link"] = e, i.inside["email-link"] = t)
            ...
            if ("undefined" != typeof self && self.Prism && self.document) {
                ...
                var e = window.Prism, t = {
                        ...
                        h: "c",
                        tex: "latex"
                    }, n = "data-src-status", a = "loading", r = "loaded",
                ...
                e.hooks.add("before-highlightall", (function (e) {
                    ...
                    if (s.matches(i)) {
                        ...
                        var c = s.getAttribute("data-src"), p = o.language;
                        if ("none" === p) {
                ...
                var s = !(e.plugins.fileHighlight = {
                    highlight: function (t) {
                        for (var n, a = (t || document).querySelectorAll(i), r = 0; n = a[r++];) e.highlightElement(n)
                    }
                });
            ...
            if (e.code) {
                var t = e.element.parentNode, n = /(?:^|\s)keep-initial-line-feed(?:\s|$)/;
            ...
            if ("undefined" != typeof self && void 0 !== d && "undefined" != typeof document) {
                var e = /<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/g,
                    t = /^#?((?:[\da-f]){3,4}|(?:[\da-f]{2}){3,4})$/i, n = [function (e) {
                        var n = t.exec(e);
                        if (n) {
                ...
                d.hooks.add("wrap", (function (t) {
                    if ("color" === t.type || 0 <= t.classes.indexOf("color")) {
                        for (var a, r = t.content, i = r.split(e).join(""), o = 0, s = n.length; o < s && !a; o++) a = n[o](i);
                        if (!a) return;
            ...
            if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
                var e = {
                    ...
                    xeoracube: "xeora",
                    yml: "yaml"
                }, n = {}, a = "components/", r = d.util.currentScript();
                if (r) {
                    var i = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
                        o = /(^|\/)[\w-]+\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i, s = r.getAttribute("data-autoloader-path");
                    if (null != s) a = s.trim().replace(/\/?$/, "/"); else {
                        var l = r.src;
                        i.test(l) ? a = l.replace(i, "components/") : o.test(l) && (a = l.replace(o, "$1components/"))
                    }
                }
                var c = d.plugins.autoloader = {languages_path: a, use_minified: !0, loadLanguages: u};
            ...
            function u(a, r, i) {
                ...
                0 !== o ? a.forEach((function (a) {
                    !function (a, r, i) {
                        ...
                        function s() {
                            var e = n[a];
                            e || (e = n[a] = {callbacks: []}), e.callbacks.push({
                                success: r,
                                error: i
            ...
            if (t.matches('script[type="text/plain"]')) {
                var n = document.createElement("code"), a = document.createElement("pre");
    ...
    n.g = function () {
        ...
        function e(e) {
            e.innerHTML = e.innerHTML.trim(), "pre" !== e.parentElement.localName && (e.outerHTML = "<pre>" + e.outerHTML + "</pre>")
        }

        ["prism"].forEach((e => n(1)("./" + e))), document.querySelectorAll("[_code]").forEach((function (t) {
            {
                let n = t.attributes._code.value;
                t.classList.add("language-" + n), "code" === t.localName ? e(t) : "pre" === t.localName && void 0 !== t.childNodes[0] && ("code" !== t.childNodes[0].localName && (t.innerHTML = "<code>" + t.innerHTML + "</code>"), e(t.childNodes[0]))
            }
        }))
    })()
})();